...
public final class ScanUtils {
	 ...
	 * @param classFilters
	 */
	public ScanUtils(Boolean excludeInner, Boolean checkInOrEx, List<String> classFilters) {
	...
	private void doScanPackageClassesByFile(Set<Class<?>> classes, String packageName, String packagePath,
		...
		for (File file : dirfiles) {
			if (file.isDirectory()) {
				...
				String className = file.getName().substring(0, file.getName().length() - LENGTH_FOR_CLASS);
				try {
