...
//import org.dxx.rpc.registry.GetServerLocationResponse.Service;
...
//	 * Create channels.
//	 * </p>
//	 * <li>Important : Synchronized, avoid same channel be created multi times.
//	 */
...
//
//	/**
//	 * 把 {@link GetServerLocationResponse} 中的服务端url追加到启动列表中
//	 * <p>
//	 *
//	 * @param startupList
//	 * @param response 
//	*/
//
//	private void appendServers(final List<ClientStartup> startupList, GetServerLocationResponse response) {
//		if (response == null) {
